    ...
    public partial class App : Application
    {
        ...
        private void App_Startup(object sender, StartupEventArgs e)
        {
            if(e.Args.Length < 2)
            {
                ...
                throw new ArgumentException("arguments are /resource /redirectUri /clientId. /resource is mandatory.");
            }
            ...
            for (int i = 0; i != e.Args.Length; ++i)
            {
                ...
                if (e.Args[i] == "/redirectUri")
                {
                    _redirectUri = e.Args[i + 1];
                }

                if (e.Args[i] == "/clientId")
                {
                    _clientId = e.Args[i + 1];
                }
            }
